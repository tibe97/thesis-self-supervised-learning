...
dataset_train_kNN = STL10('STL10/', split="train", download=True, transform=test_transforms)
dataset_test = STL10('STL10/', split="test", download=True, transform=test_transforms)
"""
